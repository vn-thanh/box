...
static func build(npc: NPC3D) -> void:
	...
	var shirt_colors := [
		Color(0.3, 0.55, 0.7), Color(0.7, 0.3, 0.3), Color(0.3, 0.6, 0.35),
		Color(0.5, 0.35, 0.6), Color(0.8, 0.6, 0.3), Color(0.35, 0.35, 0.4),
	]
	if npc.gender == "female":
		shirt_colors = [
			Color(0.9, 0.4, 0.55), Color(0.85, 0.5, 0.7), Color(0.7, 0.4, 0.8),
			Color(0.5, 0.7, 0.9), Color(0.9, 0.7, 0.4), Color(0.6, 0.8, 0.5),
		]
	var pants_colors := [
		Color(0.2, 0.22, 0.3), Color(0.25, 0.2, 0.15),
		Color(0.3, 0.3, 0.32), Color(0.15, 0.15, 0.18),
	]
	if npc.gender == "female":
		pants_colors = [
			Color(0.35, 0.3, 0.45), Color(0.3, 0.25, 0.35),
			Color(0.25, 0.3, 0.4), Color(0.4, 0.35, 0.3),
		]
	var hair_colors := [
		Color(0.25, 0.18, 0.12), Color(0.15, 0.1, 0.08), Color(0.4, 0.3, 0.15),
		Color(0.1, 0.1, 0.12), Color(0.5, 0.4, 0.2),
	]
	if npc.age > 65:
		hair_colors = [Color(0.8, 0.8, 0.78), Color(0.7, 0.7, 0.68), Color(0.6, 0.6, 0.58)]
	var skin_colors := [
		Color(0.85, 0.72, 0.6), Color(0.78, 0.65, 0.52),
		Color(0.7, 0.58, 0.45), Color(0.9, 0.78, 0.65),
	]
	...
	# Người già còng lưng
	if npc.age > 60:
		npc.bone_torso.rotation.x = clampf((npc.age - 60) / 25.0, 0, 1) * 0.18
